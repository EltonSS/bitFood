...
import Interface.Formularios.Registrar.frmPermissaoRegistrar;
...
import Interface.Formularios.Alterar.FrmPermissaoAlterar;
import Interface.Formularios.Registrar.frmVincularPermissao;
...
public class frmPermissao extends javax.swing.JDialog {
    ...
    int xx, yy, id_prm, num = 1;
    String desc_prm, status_prm;

    public frmPermissao(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        btVincularPermissao = new rojeru_san.RSButtonRiple();
        ...
        btDeletarRegistro.setToolTipText("Deletar Registro");
        ...
        menuTabelaRegistro.add(btDeletarRegistro, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 180, -1));
        ...
        btDeletarRegistro1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/BotoesFormularios/Vincular Permissao.png"))); // NOI18N
        btDeletarRegistro1.setText("Vincular Permissão");
        btDeletarRegistro1.setToolTipText("Vincular Permissão");
        ...
        menuTabelaRegistro.add(btDeletarRegistro1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 180, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/FachadasFormularios/Permissoes.png"))); // NOI18N
        ...
        btVincularPermissao.setBackground(new java.awt.Color(0, 2, 61));
        btVincularPermissao.setBorder(null);
        btVincularPermissao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagem/BotoesFormularios/Vincular Permissao.png"))); // NOI18N
        btVincularPermissao.setText("Vincular Permissões");
        btVincularPermissao.setToolTipText("Vincular Permissões");
        btVincularPermissao.setColorHover(new java.awt.Color(0, 204, 102));
        btVincularPermissao.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btVincularPermissao.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        btVincularPermissao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btVincularPermissaoActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(btVincularPermissao, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(100, 100, 100)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(btVincularPermissao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtConsultarRegistro, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(8, 8, 8)
        ...
        getContentPane().add(rSPanelShadow1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, 500));
    ...
    public void consultarRegistro() {
        ...
        if (num == 0) {
            preencherTabela(" select * from tab_permissao where desc_prm like '%" + txtConsultarRegistro.getText() + "%' and status_prm = 'ativo' order by desc_prm asc");
            num = 1;
        } else {
            if (num == 1) {
                preencherTabela(" select * from tab_permissao where id_prm = '" + txtConsultarRegistro.getText() + "' and status_prm = 'ativo' ");
            }
        }
    }
    ...
    public void atualizaTabela() {
        ...
        preencherTabela(" select * from tab_permissao where status_prm = 'ativo'");
    }

    public void preencherTabela(String SQL) {

        ArrayList dados = new ArrayList();
        String[] Colunas = new String[]{"Permissões"};
        conBanco.conexao();
        conBanco.executaSQL(SQL);
        try {
            conBanco.rs.first();
            do {
                dados.add(new Object[]{conBanco.rs.getString("desc_prm")});
            } while (conBanco.rs.next());
        } catch (SQLException ex) {
        }
        ModeloTabela modTabela = new ModeloTabela(dados, Colunas);
        tabelaForm.setModel(modTabela);
        tabelaForm.getColumnModel().getColumn(0).setPreferredWidth(690);
    ...
    private void btNovoRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoRegistroActionPerformed
        ...
        frmPermissaoRegistrar frmPermReg = new frmPermissaoRegistrar(null, true, this);
        frmPermReg.setVisible(true);
    ...
    private void btDeletarRegistroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeletarRegistroActionPerformed
        ...
        if (opcao_escolhida == JOptionPane.YES_OPTION) {
            String descPerm = "" + tabelaForm.getValueAt(tabelaForm.getSelectedRow(), 0);
            crudPrm.setDescPrm(descPerm);
            crudPrm.ConsultarPermissao();
            id_prm = crudPrm.getIdPrm();
            status_prm = "não ativo";
            crudPrm.DesativarPermissao(id_prm, status_prm);
            atualizaTabela();
        }
    }//GEN-LAST:event_btDeletarRegistroActionPerformed

    public void chamarFormularioAtualizarPermissao() {

        String descPerm = "" + tabelaForm.getValueAt(tabelaForm.getSelectedRow(), 0);
        crudPrm.setDescPrm(descPerm);
        crudPrm.ConsultarPermissao();
        desc_prm = crudPrm.getDescPrm();
        status_prm = crudPrm.getStatusPrm();
        id_prm = crudPrm.getIdPrm();
        FrmPermissaoAlterar frmPermAlterar = new FrmPermissaoAlterar(null, true, desc_prm, status_prm, id_prm, this);
        frmPermAlterar.setVisible(true);
    }

    public void chamarVincularPermissao() {
        ...
        status_prm = crudPrm.getStatusPrm();
        id_prm = crudPrm.getIdPrm();
        frmVincularPermissao frmVincPerm = new frmVincularPermissao(null, true, desc_prm, status_prm, id_prm);
        frmVincPerm.setVisible(true);
    }
...
//        }
    ...
    private void btVincularPermissaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVincularPermissaoActionPerformed

//        String descPerm = "" + tabelaForm.getValueAt(tabelaForm.getSelectedRow(), 0);
//        if ("".equals(descPerm)) {
//            JOptionPane.showConfirmDialog(parente, "Selecione uma permissão para poder realizar o vínculum!!");
//        } else {            
//        }
        chamarVincularPermissao();
    }//GEN-LAST:event_btVincularPermissaoActionPerformed
    ...
    private rojeru_san.RSButtonRiple btVincularPermissao;
