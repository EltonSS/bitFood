...
public class frmOrigemMercadoriaRegistrar extends javax.swing.JDialog {

    private final JDialog parente;
    crudOrigemMercadoria crudOrgMerc = new crudOrigemMercadoria();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy;
    String desc_Org_Merc;

    public frmOrigemMercadoriaRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Origem Mercadoria");
        ...
        txtDescOrigemMercadoria.setToolTipText("Digite a descrição da origem mercadoria");
        ...
        txtDescOrigemMercadoria.setPlaceholder("Digite a descrição da origem mercadoria");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescOrigemMercadoria, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void limpaCampos() {
        ...
        txtDescOrigemMercadoria.setText("");
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescOrigemMercadoria.getText().equals("")) {
            ...
            if (txtDescOrigemMercadoria.getText().equals((String) desc_Org_Merc)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescOrigemMercadoria.getText() + " cadastrado no sistema!!");
                txtDescOrigemMercadoria.requestFocus();
            } else {
                crudOrgMerc.InserirOrigemMercadoria(txtDescOrigemMercadoria.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
