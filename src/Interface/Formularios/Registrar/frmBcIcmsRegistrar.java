...
public class frmBcIcmsRegistrar extends javax.swing.JDialog {
    ...
    public frmBcIcmsRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar BC ICMS");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescBcIcms, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void limpaCampos() {
        ...
        txtDescBcIcms.setText("");
    }

    public void atualizaTabela() {

        frmTributos frmTributos = (frmTributos) parente;
        frmTributos.atualizaTabelaIcms();
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescBcIcms.getText().equals("")) {
            ...
            if (txtDescBcIcms.getText().equals((String) desc_Bc_Icms)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescBcIcms.getText() + " cadastrado no sistema!!");
                txtDescBcIcms.requestFocus();
            } else {
                crudBcIcms.InserirBcIcms(txtDescBcIcms.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
