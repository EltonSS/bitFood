...
public class frmBcIcmsStRegistrar extends javax.swing.JDialog {

    private final JDialog parente;
    crudBcIcmsSt crudBcIcmsSt = new crudBcIcmsSt();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy;
    String desc_Bc_Icms_St;

    public frmBcIcmsStRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar BC ICMS ST");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescBcIcmsSt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void limpaCampos() {
        ...
        txtDescBcIcmsSt.setText("");
    }

    public void atualizaTabela() {

        frmTributos frmTributos = (frmTributos) parente;
        frmTributos.atualizaTabelaIcmsSt();
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescBcIcmsSt.getText().equals("")) {
            ...
            if (txtDescBcIcmsSt.getText().equals((String) desc_Bc_Icms_St)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescBcIcmsSt.getText() + " cadastrado no sistema!!");
                txtDescBcIcmsSt.requestFocus();
            } else {
                crudBcIcmsSt.InserirBcIcmsSt(txtDescBcIcmsSt.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
