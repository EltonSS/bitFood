...
public class frmCestRegistrar extends javax.swing.JDialog {
    ...
    public frmCestRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar CEST");
        ...
        txtNumCest.setToolTipText("Digite o número do CEST");
        ...
        txtNumCest.setPlaceholder("Digite o número do CEST");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtNumCest, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void salvarRegistro() {
        ...
        if (txtNumCest.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Digite o número do CEST!!");
            txtNumCest.requestFocus();
        } else {
            verificarRegistro();
            if (txtNumCest.getText().equals((String) num_Cest)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtNumCest.getText() + " cadastrado no sistema!!");
                txtNumCest.requestFocus();
            } else {
                crudCest.InserirCest(txtNumCest.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
