...
public class frmCrtRegistrar extends javax.swing.JDialog {
    ...
    public frmCrtRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescCrt, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void salvarRegistro() {
        ...
        if (txtDescCrt.getText().equals("")) {
            ...
            if (txtDescCrt.getText().equals((String) desc_Crt)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescCrt.getText() + " cadastrado no sistema!!");
                txtDescCrt.requestFocus();
            } else {
                crudCrt.InserirCrt(txtDescCrt.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
