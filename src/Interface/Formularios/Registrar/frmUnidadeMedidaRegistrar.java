...
public class frmUnidadeMedidaRegistrar extends javax.swing.JDialog {

    private final JDialog parente;
    crudUnidadeMedida crudUnidMed = new crudUnidadeMedida();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy;
    String desc_Unid_Med;

    public frmUnidadeMedidaRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescUnidadeMedida, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void salvarRegistro() {
        ...
        if (txtDescUnidadeMedida.getText().equals("")) {
            ...
            if (txtDescUnidadeMedida.getText().equals((String) desc_Unid_Med)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescUnidadeMedida.getText() + " cadastrado no sistema!!");
                txtDescUnidadeMedida.requestFocus();
            } else {
                crudUnidMed.InserirUnidadeMedida(txtDescUnidadeMedida.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
