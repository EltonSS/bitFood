...
public class frmCstOrigemRegistrar extends javax.swing.JDialog {
    ...
    public frmCstOrigemRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {

        super(parent, modal);
        initComponents();
        txtDescCstOrigem.requestFocus();
        this.parente = p;
    }
    ...
    private void initComponents() {
        ...
        txtDescCstOrigem = new rojerusan.RSMetroTextPlaceHolder();
        ...
        jLabel1.setText("Cadastrar CST Origem");
        ...
        txtDescCstOrigem.setForeground(new java.awt.Color(0, 2, 61));
        txtDescCstOrigem.setToolTipText("Digite a descrição do CST origem");
        txtDescCstOrigem.setBorderColor(new java.awt.Color(0, 2, 61));
        txtDescCstOrigem.setBotonColor(new java.awt.Color(0, 2, 61));
        txtDescCstOrigem.setPhColor(new java.awt.Color(0, 2, 61));
        txtDescCstOrigem.setPlaceholder("Digite a descrição do CST origem");
        txtDescCstOrigem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDescCstOrigemActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescCstOrigem, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(txtDescCstOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public void limpaCampos() {
        ...
        txtDescCstOrigem.setText("");
    }

    public void atualizaTabela() {

        frmTributacao frmTrib = (frmTributacao) parente;
        frmTrib.atualizaTabelaCstOrigem();
    }
    ...
    public void verificarRegistro() {
        ...
        conBanco.conexao();
        conBanco.executaSQL("Select * from tab_cst_origem where desc_cst_org ='" + txtDescCstOrigem.getText() + "'");
        try {
            conBanco.rs.first();
    ...
    public void salvarRegistro() {
        ...
        if (txtDescCstOrigem.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Digite a descrição do cst de origem!!");
            txtDescCstOrigem.requestFocus();
        } else {
            verificarRegistro();
            if (txtDescCstOrigem.getText().equals((String) desc_Cst_Org)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescCstOrigem.getText() + " cadastrado no sistema!!");
                txtDescCstOrigem.requestFocus();
            } else {
                crudTrib.InserirCstOrigem(txtDescCstOrigem.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
    ...
    private void txtDescCstOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDescCstOrigemActionPerformed

        salvarRegistro();
    }//GEN-LAST:event_txtDescCstOrigemActionPerformed
    ...
    private rojerusan.RSMetroTextPlaceHolder txtDescCstOrigem;
