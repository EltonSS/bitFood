...
public class frmCategoriaProdutoRegistrar extends javax.swing.JDialog {
    ...
    int xx, yy;
    String desc_Cat_Prod;

    public frmCategoriaProdutoRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Categoria Produto");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescCategoriaProduto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void limpaCampos() {
        ...
        txtDescCategoriaProduto.setText("");
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescCategoriaProduto.getText().equals("")) {
            ...
            if (txtDescCategoriaProduto.getText().equals((String) desc_Cat_Prod)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescCategoriaProduto.getText() + " cadastrado no sistema!!");
                txtDescCategoriaProduto.requestFocus();
            } else {
                crudCatProd.InserirCategoriaProduto(txtDescCategoriaProduto.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
