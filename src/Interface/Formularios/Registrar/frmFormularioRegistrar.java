...
public class frmFormularioRegistrar extends javax.swing.JDialog {
    ...
    public frmFormularioRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(370, 287));
        setResizable(false);
        ...
        jLabel1.setText("Registrar Formulário");
        ...
        txtDescricaoFormulario.setPlaceholder("Digite a descrição do fomulário");
        ...
        getContentPane().add(rSPanelShadow1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 370, 210));
    ...
    public void atualizaTabela() {
        ...
        frmFormulario frmForm = (frmFormulario) parente;
        frmForm.atualizaTabela();
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescricaoFormulario.getText().equals("")) {
            ...
            if (txtDescricaoFormulario.getText().equals((String) descFrm)) {
                ...
                crudFrm.setDescFrm(txtDescricaoFormulario.getText());
                crudFrm.setStatusFrm("ativo");
                crudFrm.InserirFormulario();
                limpaCampos();
                atualizaTabela();
            }
        }
