...
public class frmCsosnRegistrar extends javax.swing.JDialog {
    ...
    public frmCsosnRegistrar(java.awt.Frame parent, boolean modal, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar CSOSN");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescCsosn, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public void limpaCampos() {
        ...
        txtDescCsosn.setText("");
    }

    public void atualizaTabela() {

        frmTributos frmTributos = (frmTributos) parente;
        frmTributos.atualizaTabelaCsosn();
    }
    ...
    public void salvarRegistro() {
        ...
        if (txtDescCsosn.getText().equals("")) {
            ...
            if (txtDescCsosn.getText().equals((String) desc_Csosn)) {
                JOptionPane.showMessageDialog(rootPane, "Já existe " + txtDescCsosn.getText() + " cadastrado no sistema!!");
                txtDescCsosn.requestFocus();
            } else {
                crudCsosn.InserirCsosn(txtDescCsosn.getText(), "ativo");
                limpaCampos();
                atualizaTabela();
            }
        }
