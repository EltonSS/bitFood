...
public final class FrmCstAlterar extends javax.swing.JDialog {

    private final JDialog parente;
    crudCst crudCst = new crudCst();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy, id_Cst;
    String desc_Cst, status_Cst;

    public FrmCstAlterar(java.awt.Frame parent, boolean modal, int idCst, String descCst, String statusCst, JDialog p) {

        super(parent, modal);
        initComponents();
        this.parente = p;
        txtDescCst.requestFocus();
        preencherCampos(idCst, descCst, statusCst);
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtDescCst, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        txtDescCst.getAccessibleContext().setAccessibleName("");
    ...
    public void atualizaTabela() {
        ...
        frmTributos.atualizaTabelaCst();
    }

    public void preencherCampos(int idCst, String descCst, String statusCst) {

        id_Cst = idCst;
        txtDescCst.setText(descCst);
        if (statusCst.equals("ativo")) {
            status_Cst = statusCst;
    ...
    public void atualizarRegistro() {
        ...
        if (txtDescCst.getText().equals("")) {
            ...
            txtDescCst.requestFocus();
                ...
                crudCst.AlterarCst(id_Cst, txtDescCst.getText(), status_Cst);
                atualizaTabela();
                dispose();
            }
        }
