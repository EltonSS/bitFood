...
public class FrmPermissaoAlterar extends javax.swing.JDialog {

    private final JDialog parente;
    crudPermissao crudPrm = new crudPermissao();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy, id_Prm;
    String dscPrm, statusPrm, descPrm;

    public FrmPermissaoAlterar(java.awt.Frame parent, boolean modal, String descPrm, String status, int IdPrm, JDialog p) {

        super(parent, modal);
        initComponents();
        this.parente = p;
        txtDescricaoPermissao.requestFocus();
        preencherCampos(descPrm, status);
        //Inicializando os resultados da consulta que ficou realizada no fomrulário de Permissão, passados com parâmtero.
        id_Prm = IdPrm;
        statusPrm = status;
    }
    ...
    public void preencherCampos(String desc_crudPrm, String status) {
    ...
    public void atualizarRegistro() {
        ...
        if (txtDescricaoPermissao.getText().equals("")) {
            ...
            if (txtDescricaoPermissao.getText().equals((String) descPrm)) {
                ...
                crudPrm.AlterarPermissao(id_Prm, txtDescricaoPermissao.getText(), statusPrm);
                atualizaTabela();
                dispose();
            }
        }
