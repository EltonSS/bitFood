...
public final class FrmCestAlterar extends javax.swing.JDialog {

    private final JDialog parente;
    crudCest crudCest = new crudCest();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy, id_Cest;
    String num_Cest, status_Cest;

    public FrmCestAlterar(java.awt.Frame parent, boolean modal, int idCest, String numCest, String statusCest, JDialog p) {

        super(parent, modal);
        initComponents();
        this.parente = p;
        txtNumCest.requestFocus();
        preencherCampos(idCest, numCest, statusCest);
    }
    ...
    private void initComponents() {
        ...
        txtNumCest = new rojerusan.RSMetroTextPlaceHolder();
        ...
        txtNumCest.setForeground(new java.awt.Color(0, 2, 61));
        txtNumCest.setToolTipText("Digite o CEST");
        txtNumCest.setBorderColor(new java.awt.Color(0, 2, 61));
        txtNumCest.setBotonColor(new java.awt.Color(0, 2, 61));
        txtNumCest.setPhColor(new java.awt.Color(0, 2, 61));
        txtNumCest.setPlaceholder("Digite o CEST");
        txtNumCest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtNumCestActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtNumCest, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtNumCest, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        txtNumCest.getAccessibleContext().setAccessibleName("");
    ...
    public void atualizaTabela() {
        ...
        frmTributos.atualizaTabelaCest();
    }

    public void preencherCampos(int idCest, String numCest, String statusCest) {

        id_Cest = idCest;
        txtNumCest.setText(numCest);
        if (statusCest.equals("ativo")) {
            status_Cest = statusCest;
    ...
    public void verificarRegistro() {
        ...
        conBanco.conexao();
        conBanco.executaSQL("Select * from tab_cest where num_cest ='" + txtNumCest.getText() + "'");
        try {
            conBanco.rs.first();
            num_Cest = conBanco.rs.getString("num_cest");
    ...
    public void atualizarRegistro() {
        ...
        if (txtNumCest.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Digite a descrição do CEST!!");
            txtNumCest.requestFocus();
        } else {
            verificarRegistro();
            if (txtNumCest.getText().equals((String) num_Cest)) {
            ...
            txtNumCest.requestFocus();
                ...
                crudCest.AlterarCest(id_Cest, txtNumCest.getText(), status_Cest);
                atualizaTabela();
                dispose();
            }
        }
    ...
    private void chkStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkStatusActionPerformed
        ...
        if (!chkStatus.isSelected()) {
            status_Cest = "não ativo";
        } else {
            status_Cest = "ativo";
        }
    }//GEN-LAST:event_chkStatusActionPerformed

    private void txtNumCestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtNumCestActionPerformed

        atualizarRegistro();
    }//GEN-LAST:event_txtNumCestActionPerformed
    ...
    private rojerusan.RSMetroTextPlaceHolder txtNumCest;
