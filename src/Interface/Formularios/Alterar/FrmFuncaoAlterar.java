...
public class FrmFuncaoAlterar extends javax.swing.JDialog {

    private final JDialog parente;
    crudFuncao crudFunc = new crudFuncao();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy, id_Frm;
    String dscFrm, statusFrm, descFunc;

    public FrmFuncaoAlterar(java.awt.Frame parent, boolean modal, String descFunc, String status, int IdPrm, JDialog p) {

        super(parent, modal);
        initComponents();
        this.parente = p;
        txtDescricaoFormulario.requestFocus();
        preencherCampos(descFunc, status);
    ...
    public void preencherCampos(String desc_crudFunc, String status) {

        txtDescricaoFormulario.setText(desc_crudFunc);
    ...
    public void atualizarRegistro() {
        ...
        if (txtDescricaoFormulario.getText().equals("")) {
            ...
            if (txtDescricaoFormulario.getText().equals((String) descFunc)) {
                ...
                crudFunc.AlterarFuncao(id_Frm, txtDescricaoFormulario.getText(), statusFrm);
                atualizaTabela();
                dispose();
            }
        }
