...
import Banco.CRUD.crudUnidadeMedida;
...
public class FrmUnidadeMedidaAlterar extends javax.swing.JDialog {

    private final JDialog parente;
    crudUnidadeMedida crudUnidMed = new crudUnidadeMedida();
    ConectaBanco conBanco = new ConectaBanco();
    int xx, yy, id_Unid_Med;
    String desc_Unid_Med, status_Unid_Med;

    public FrmUnidadeMedidaAlterar(java.awt.Frame parent, boolean modal, int idUnidMed, String descUnidMed, String statusUnidMed, JDialog p) {

        super(parent, modal);
        initComponents();
        this.parente = p;
        txtDescUnidadeMedida.requestFocus();
        preencherCampos(idUnidMed, descUnidMed, statusUnidMed);
    }
    ...
    private void initComponents() {
        ...
        txtDescUnidadeMedida = new rojerusan.RSMetroTextPlaceHolder();
        ...
        jLabel1.setText("Alterar Unidade de Medida");
        ...
        txtDescUnidadeMedida.setForeground(new java.awt.Color(0, 2, 61));
        txtDescUnidadeMedida.setToolTipText("Digite a descrição da unidade de medida");
        txtDescUnidadeMedida.setBorderColor(new java.awt.Color(0, 2, 61));
        txtDescUnidadeMedida.setBotonColor(new java.awt.Color(0, 2, 61));
        txtDescUnidadeMedida.setPhColor(new java.awt.Color(0, 2, 61));
        txtDescUnidadeMedida.setPlaceholder("Digite a descrição da unidade de medida");
        txtDescUnidadeMedida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDescUnidadeMedidaActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtDescUnidadeMedida, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtDescUnidadeMedida, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public void atualizaTabela() {
        ...
        frmUnidadeMedida frmUnidMed = (frmUnidadeMedida) parente;
        frmUnidMed.atualizaTabela();
    }

    public void preencherCampos(int idUnidMed, String descUnidMed, String statusUnidMed) {

        id_Unid_Med = idUnidMed;
        txtDescUnidadeMedida.setText(descUnidMed);
        if (statusUnidMed.equals("ativo")) {
            status_Unid_Med = statusUnidMed;
    ...
    public void verificarRegistro() {
        ...
        conBanco.conexao();
        conBanco.executaSQL("Select * from tab_unidade_medida where desc_unid_med ='" + txtDescUnidadeMedida.getText() + "'");
        try {
            conBanco.rs.first();
    ...
    public void atualizarRegistro() {
        ...
        if (txtDescUnidadeMedida.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Digite a descrição da unidade de medida!!");
            txtDescUnidadeMedida.requestFocus();
        } else {
            verificarRegistro();
            if (txtDescUnidadeMedida.getText().equals((String) desc_Unid_Med)) {
            ...
            txtDescUnidadeMedida.requestFocus();
                ...
                crudUnidMed.AlterarUnidadeMedida(id_Unid_Med, txtDescUnidadeMedida.getText(), status_Unid_Med);
                atualizaTabela();
                dispose();
            }
        }
    ...
    private void chkStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkStatusActionPerformed
        ...
        if (!chkStatus.isSelected()) {
            status_Unid_Med = "não ativo";
        } else {
            status_Unid_Med = "ativo";
        }
    }//GEN-LAST:event_chkStatusActionPerformed

    private void txtDescUnidadeMedidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDescUnidadeMedidaActionPerformed

        atualizarRegistro();
    }//GEN-LAST:event_txtDescUnidadeMedidaActionPerformed
    ...
    private rojerusan.RSMetroTextPlaceHolder txtDescUnidadeMedida;
