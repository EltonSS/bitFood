...
public class FrmCstOrigemAlterar extends javax.swing.JDialog {
    ...
    public FrmCstOrigemAlterar(java.awt.Frame parent, boolean modal, int idFabProd, String descFabProd, String statusFabProd, JDialog p) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Alterar CST Origem");
        ...
        txtDescCstOrigem.setToolTipText("Digite a descrição do CST de origem");
        ...
        txtDescCstOrigem.setPlaceholder("Digite a descrição do CST de origem");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtDescCstOrigem, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        txtDescCstOrigem.getAccessibleContext().setAccessibleName("");
    ...
    public void preencherCampos(int idFabProd, String descFabProd, String statusFabProd) {
        ...
        txtDescCstOrigem.setText(descFabProd);
    ...
    public void verificarRegistro() {
        ...
        conBanco.conexao();
        conBanco.executaSQL("Select * from tab_fabricante_produto where desc_fab_prod ='" + txtDescCstOrigem.getText() + "'");
        try {
            conBanco.rs.first();
    ...
    public void atualizarRegistro() {
        ...
        if (txtDescCstOrigem.getText().equals("")) {
            ...
            verificarRegistro();
            if (txtDescCstOrigem.getText().equals((String) desc_Fab_Prod)) {
            ...
            txtDescCstOrigem.requestFocus();
                ...
                crudFabProd.AlterarFabricanteProduto(id_Fab_Prod, txtDescCstOrigem.getText(), status_Fab_Prod);
                atualizaTabela();
                dispose();
            }
        }
